...
La première étape est de s'assurer que vous avez la bonne collection ouverte. La plupart de votre travail sera fait dans la collection pour votre langue. Si nécessaire, vous pouvez la modifier maintenant. Voir [3.1 Collection](03-More-information.md#31) pour savoir comment faire.

### 2.3 Créer un livre basé sur Livre simple

-   Dans le volet **Sources pour des nouveaux livres**, cliquez sur **Livre simple**
...
-   Cliquez sur le bouton **Créer un livre depuis cette source**.
    ...
    *Bloom ajoute un nouveau livre de ce modèle à la collection de livres et l’ouvre dans l’onglet « Éditer ». Il y a six pages déjà créées.*
    ...
    Elle s’ouvre sur la page **Couverture extérieure**.
    
:::info
Notez que le livre apparaît dans l’onglet **Éditer**. Le volet gauche est appelé Pages. Il montre les pages qui sont dans votre livre. La page en surbrillance dans le volet **Pages** s’affiche au centre.
:::
...
-   Si necessaire, cliquez sur la page à gauche.  
...
-   Modifier la page de titre comme désiré.
    ...
    Pour plus de détails, voir [3.4 images](03-More-information.md#34)
...
-   Cliquez sur « **+ Ajouter une page** »  
    ...
    *La boîte de dialogue* **Ajouter une page** *s’affiche et affiche les modèles que vous pouvez utiliser pour ajouter d’autres pages à votre livre.*
    ...
    ![](media/9979b59edc86c849e1b3b99122d6b4a3.png)
...
-   Saisissez le texte.
    ...
    Pour plus de détails, voir [3.3 text](03-More-information.md#33)
